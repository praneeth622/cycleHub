                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p style={{ color: mode === 'dark' ? 'white' : '' }} className="leading-relaxed">Using the cycle management website has been a game-changer for me! It's so convenient to reserve a cycle for my daily commute to college. No more hassle of searching for available cycles on campus. Highly recommended!</p>
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p  style={{color: mode === 'dark' ? 'white' : ''}}className="leading-relaxed">The cycle management website is a lifesaver! It not only promotes eco-friendly transportation but also saves us time and effort. With its intuitive interface and reliable service, cycling around campus has become my favorite part of the day.</p>
                                <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
                        ...
                        <div className="lg:w-1/3 lg:mb-0 p-4">
                            <div className="h-full text-center">
                                ...
                                <p style={{color: mode === 'dark' ? 'white' : ''}} className="leading-relaxed">As a senior, I've seen the cycle management system evolve over the years, and I must say, it's now at its peak efficiency. From quick bookings to easy returns, it's made campus life much smoother. Kudos to the team behind it!</p>
                                <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
